//! wgpu backend for omg: a Gemma 3 / Gemma 4 forward pass written in WGSL
...
//!
//! Debugging (native only): `OMG_WGPU_PROFILE=1` prints GPU time per
//! kernel after each request (timestamp queries), `OMG_WGPU_LAYERS=n` runs
